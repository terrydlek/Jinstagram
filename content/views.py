...
class Main(APIView):
    def get(self, request):
        feed_object_list = Feed.objects.all().order_by("-id")  # feed list를 만들어서 feed_list에 담기 (select * from Feed)
        feed_list = []
...
class Profile(APIView):
    def get(self, request):
        ...
        return render(request, 'content/profile.html',
                      context=dict(feed_list=feed_list, like_feed_list=like_feed_list,
